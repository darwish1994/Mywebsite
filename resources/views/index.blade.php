                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-md-6">
                                <div class="short_contact_list">
                                    <ul>
                                        <li><a href="mailto:{{$links['google']}}"> <i
                                                    class="fa fa-envelope"></i> {{$links['google']}}</a></li>
                                        <li><a href="callTo:{{$links['phone']}}"> <i
                                                    class="fa fa-phone"></i> {{$links['phone']}}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="slider_text ">
                                        ...
                                        <div class="video_service_btn">
                                            <a href="{{$item->text_btn_url}}"
                                               class="boxed-btn3">{{$item->text_btn_title}}</a>

                                            <a href="storage/{{$item->video}}" class="boxed-btn3-white"> <i
                                                    class="fa fa-play"></i>See How it Work</a>
                ...
                <div class="row">
                    @foreach($project as $project)
                        <div class="col-xl-4 col-md-4">
                            <div class="single_service" style="background-image:url('storage/{{$project->image}}')">
        ...
        <div class="row no-gutters align-items-center">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="about_info">
                    ...
                    <p>These cases are perfectly simple and easy to distinguish. In a free hour, <br> when our power of
                        choice is untrammelled and when nothing prevents <br> our being able to do what we like best.
                    </p>
                    <ul>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="section_title text-center mb-50">
                    ...
                    <p>These cases are perfectly simple and easy to distinguish. In a free <br> hour, when our power of
                ...
                <div class="financial_active owl-carousel">
                    <div class="single_finalcial_wrap">
                        ...
                        <p>These cases are perfectly simple and easy to distinguish. In a free hour, when our power of
                            choice is untrammelled and when nothing prevents our being able to do what we like best.</p>
                    </div>
                    <div class="single_finalcial_wrap">
                        <h3>Gives you the best Financial <br>
                            solution for business</h3>
            ...
            <div class="col-xl-10 offset-xl-1">
                <div class="testmonial_active2 owl-carousel">
                    <div class="single_slider text-center" data-dot='<img src="img/testmonial/1.png" alt="#" '>
                        <p>These cases are perfectly simple and easy to distinguish. In a free hour, when our power of
                            choice is untrammelled and when nothing prevents our being able.</p>
